...
const s = StyleSheet.create({
  bg: { flex: 1, backgroundColor: GLASS.scrim, justifyContent: 'flex-end' },
  // Hoja sólida, esquinas de arriba 36 (Reglas 1 y 4).
  sheet: { backgroundColor: GLASS.hoja, paddingHorizontal: 20, paddingTop: 6, paddingBottom: 24, borderTopLeftRadius: 36, borderTopRightRadius: 36, borderWidth: 1, borderBottomWidth: 0, borderColor: GLASS.border },
  ...
  quitar: { fontFamily: FONTS.semibold, fontSize: 13, color: COLORS.textLight, paddingVertical: 8, marginBottom: 4 },
  ...
  anadirT: { fontFamily: FONTS.semibold, fontSize: 15, color: COLORS.ink },
  ...
  elegirT: { fontFamily: FONTS.semibold, fontSize: 15, color: COLORS.ink },
  elegirX: { fontFamily: FONTS.semibold, fontSize: 13, color: COLORS.textLight },
  candHead: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 6 },
  candN: { fontFamily: FONTS.semibold, fontSize: 14, color: COLORS.ink },
  ...
  cta: { height: 52, backgroundColor: COLORS.red, borderRadius: 26, alignItems: 'center', justifyContent: 'center' },
  ...
  recuentoT: { fontFamily: FONTS.semibold, fontSize: 13, color: COLORS.textMid, flexShrink: 1 },
