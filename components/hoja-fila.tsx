...
const s = StyleSheet.create({
  ...
  anadir: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: COLORS.surfaceAlt,
    borderWidth: 1, borderColor: COLORS.border, borderRadius: 14, padding: 13, marginBottom: 12 },
  ...
  elegir: { backgroundColor: COLORS.surfaceAlt, borderWidth: 1, borderColor: COLORS.border, borderRadius: 14, padding: 13, marginBottom: 12 },
  ...
  candServ: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between',
    backgroundColor: COLORS.bg, borderRadius: 10, paddingVertical: 10, paddingHorizontal: 12, marginBottom: 6 },
