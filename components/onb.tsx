...
const s = StyleSheet.create({
  ...
  back: { width: 38, height: 38, borderRadius: 4, backgroundColor: COLORS.carbonEl, borderWidth: 1, borderColor: COLORS.carbonBorder, alignItems: 'center', justifyContent: 'center', marginBottom: 24 },
  ...
  opcion: { flexDirection: 'row', alignItems: 'center', gap: 14, backgroundColor: COLORS.carbonEl, borderWidth: 1.5, borderColor: COLORS.carbonBorder, borderRadius: 6, padding: 18, marginBottom: 12 },
  ...
  input: { backgroundColor: COLORS.carbonEl, borderWidth: 1, borderColor: COLORS.carbonBorder, borderRadius: 6, padding: 16, color: '#fff', fontSize: 16, fontFamily: FONTS.medium },
