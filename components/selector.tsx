...
const s = StyleSheet.create({
  ...
  caja: { flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: COLORS.surface,
    borderWidth: 1.5, borderColor: COLORS.border, borderRadius: 8, paddingVertical: 13, paddingHorizontal: 13 },
  valor: { flex: 1, fontFamily: FONTS.medium, fontSize: 15, color: COLORS.ink },
  busca: { backgroundColor: COLORS.surface, borderWidth: 1.5, borderColor: COLORS.border, borderRadius: 8,
