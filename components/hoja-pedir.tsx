...
const s = StyleSheet.create({
  ...
  hoja: { backgroundColor: COLORS.bg, borderTopLeftRadius: 8, borderTopRightRadius: 8, paddingHorizontal: 18, paddingBottom: 18 },
  cab: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, marginBottom: 14 },
  sub: { fontFamily: FONTS.medium, fontSize: 12.5, color: COLORS.textMid, marginTop: 4, lineHeight: 18 },
  cerrar: { width: 34, height: 34, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: COLORS.border },
  vacio: { fontFamily: FONTS.medium, fontSize: 14, color: COLORS.textMid, lineHeight: 20, paddingVertical: 14 },

  cualquiera: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 14,
    borderTopWidth: 2, borderTopColor: COLORS.ink, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  cualquieraIco: { width: 38, height: 38, borderWidth: 1.5, borderColor: COLORS.border, alignItems: 'center', justifyContent: 'center' },
  cualquieraT: { fontFamily: FONTS.extrabold, fontSize: 15, color: COLORS.ink },
  cualquieraD: { fontFamily: FONTS.medium, fontSize: 12.5, color: COLORS.textMid, marginTop: 2 },
  ...
  apagado: { opacity: 0.5 },
  barbero: { marginTop: 16, paddingLeft: 12, borderLeftWidth: 3, borderLeftColor: COLORS.border },
  barberoMio: { borderLeftColor: COLORS.red },
  barberoHead: { flexDirection: 'row', alignItems: 'center', gap: 11 },
  nombreFila: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  barberoN: { fontFamily: FONTS.display, fontSize: 19, color: COLORS.ink, textTransform: 'uppercase', flexShrink: 1 },
  mio: { fontFamily: FONTS.bold, fontSize: 8.5, letterSpacing: 0.5, color: '#fff', backgroundColor: COLORS.red,
    paddingHorizontal: 6, paddingVertical: 2, overflow: 'hidden' },
  barberoMeta: { fontFamily: FONTS.medium, fontSize: 12, color: COLORS.textMid, marginTop: 2 },
  pausa: { flexDirection: 'row', alignItems: 'center', gap: 7, marginTop: 9 },
  pausaT: { fontFamily: FONTS.bold, fontSize: 12.5, color: COLORS.textMid, flexShrink: 1 },
  sinServ: { fontFamily: FONTS.medium, fontSize: 12.5, color: COLORS.textLight, marginTop: 10 },
  ...
  servD: { fontFamily: FONTS.medium, fontSize: 11.5, color: COLORS.textMid, marginTop: 1 },
  servP: { fontFamily: FONTS.display, fontSize: 18, color: COLORS.ink },
})
