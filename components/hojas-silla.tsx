...
const s = StyleSheet.create({
  ...
  barra: { height: 8, backgroundColor: COLORS.surfaceAlt, marginTop: 10, borderRadius: 4 },
  ...
  input: { borderWidth: 1, borderColor: COLORS.border, height: 50, paddingHorizontal: 14, marginTop: 12, fontFamily: FONTS.regular, fontSize: 15, color: COLORS.ink, backgroundColor: COLORS.surface, borderRadius: 8, overflow: 'hidden' },
  ...
  chipSel: { backgroundColor: COLORS.ink, borderRadius: 8 },
  ...
  aqui: { fontFamily: FONTS.bold, fontSize: 10, letterSpacing: 1, color: '#fff', backgroundColor: COLORS.ink, paddingHorizontal: 8, paddingVertical: 3, overflow: 'hidden', borderRadius: 8 },
  ...
  rojo: { height: 56, backgroundColor: COLORS.red, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 12, borderRadius: 8 },
  rojoT: { fontFamily: FONTS.semibold, fontSize: 16, color: '#fff' },
  contorno: { height: 54, borderWidth: 1, borderColor: COLORS.border, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 12, borderRadius: 8 },
