...
const s = StyleSheet.create({
  titulo: { fontFamily: FONTS.display, letterSpacing: -0.6, fontSize: 26, lineHeight: 30, color: COLORS.ink, marginTop: 4 },
  sub: { fontFamily: FONTS.medium, fontSize: 13, lineHeight: 19, color: COLORS.textMid, marginTop: 4, marginBottom: 8 },
  b: { fontFamily: FONTS.bold, color: COLORS.ink },
  ...
  tarjetaN: { flex: 1, textAlign: 'right', fontFamily: FONTS.display, fontSize: 20, color: COLORS.ink },
  ...
  serv: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 13, paddingHorizontal: 12,
    borderBottomWidth: 1, borderBottomColor: COLORS.border, borderLeftWidth: 3, borderLeftColor: 'transparent' },
  servSel: { borderLeftColor: COLORS.red, backgroundColor: COLORS.surface },
  servN: { fontFamily: FONTS.bold, fontSize: 15.5, color: COLORS.ink },
  servD: { fontFamily: FONTS.medium, fontSize: 12.5, color: COLORS.textMid, marginTop: 2 },
  servP: { fontFamily: FONTS.display, fontSize: 19, color: COLORS.ink },
  vacio: { fontFamily: FONTS.medium, fontSize: 13, color: COLORS.textMid, marginVertical: 14 },
  input: { borderWidth: 1, borderColor: COLORS.border, height: 50, paddingHorizontal: 14, marginTop: 12,
  ...
  chipT: { fontFamily: FONTS.display, fontSize: 15, color: COLORS.ink },
  local: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingVertical: 16, paddingHorizontal: 14,
    borderBottomWidth: 1, borderBottomColor: COLORS.border, borderLeftWidth: 3, borderLeftColor: 'transparent' },
  localAqui: { borderLeftColor: COLORS.red },
  localN: { flex: 1, fontFamily: FONTS.display, letterSpacing: -0.3, fontSize: 20, color: COLORS.ink },
  aqui: { fontFamily: FONTS.extrabold, fontSize: 10, letterSpacing: 1, color: '#fff', backgroundColor: COLORS.ink,
  ...
  visitaF: { width: 62, fontFamily: FONTS.display, fontSize: 18, color: COLORS.ink },
  todo: { paddingVertical: 14 },
  todoT: { fontFamily: FONTS.bold, fontSize: 13.5, color: COLORS.blue },
