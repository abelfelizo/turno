...
const s = StyleSheet.create({
  ...
  input: { borderWidth: 2, borderColor: COLORS.ink, height: 50, paddingHorizontal: 14, marginTop: 12,
  ...
  chip: { flex: 1, height: 46, borderWidth: 2, borderColor: COLORS.ink, alignItems: 'center', justifyContent: 'center' },
  chipSel: { backgroundColor: COLORS.ink },
  chipT: { fontFamily: FONTS.display, fontSize: 15, color: COLORS.ink, textTransform: 'uppercase' },
  ...
  localN: { flex: 1, fontFamily: FONTS.display, fontSize: 20, color: COLORS.ink, textTransform: 'uppercase' },
