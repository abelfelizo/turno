...
const s = StyleSheet.create({
  ...
  titulo: { fontFamily: FONTS.bold, fontSize: 30, lineHeight: 36, color: COLORS.ink, letterSpacing: -0.8 },
  ...
  rot: { flexShrink: 1, fontFamily: FONTS.bold, fontSize: 11, letterSpacing: 1.2, color: COLORS.textMid, textTransform: 'uppercase' },
  rotAccion: { fontFamily: FONTS.semibold, fontSize: 13, color: COLORS.blue },
  pest: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 16 },
  pestBtn: { minHeight: 36, paddingVertical: 8, paddingHorizontal: 14, borderRadius: 999, borderWidth: 1, borderColor: GLASS.border, justifyContent: 'center', backgroundColor: GLASS.fillStrong },
  pestOn: { backgroundColor: COLORS.ink, borderColor: COLORS.ink },
  pestT: { fontFamily: FONTS.semibold, fontSize: 14, color: COLORS.ink },
  pestTOn: { color: COLORS.onInk },
