...
const s = StyleSheet.create({
  ...
  promedio: { fontFamily: FONTS.mono, fontSize: 40, letterSpacing: -1, color: COLORS.ink },
  estrellasT: { fontSize: 15, color: COLORS.red, marginTop: -2 },
  total: { fontFamily: FONTS.regular, fontSize: 13, color: COLORS.textLight, marginTop: 3 },
  barraRow: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  barraK: { fontFamily: FONTS.monoMedium, fontSize: 11, color: COLORS.textLight, width: 10 },
  barraBg: { flex: 1, height: 6, borderRadius: 3, backgroundColor: COLORS.surfaceAlt, overflow: 'hidden' },
  barraFill: { height: 6, borderRadius: 3, backgroundColor: COLORS.ink },
  barraN: { fontFamily: FONTS.monoMedium, fontSize: 11, color: COLORS.textLight, width: 22, textAlign: 'right' },
  vacio: { fontFamily: FONTS.regular, fontSize: 14, color: COLORS.textLight, lineHeight: 20, marginVertical: 18 },
  item: { borderTopWidth: 1, borderTopColor: COLORS.divider, paddingVertical: 12 },
  itemTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  itemEstrellas: { fontSize: 14, color: COLORS.red },
  itemMeta: { fontFamily: FONTS.regular, fontSize: 13, color: COLORS.textLight },
  itemTexto: { fontFamily: FONTS.regular, fontSize: 15, color: COLORS.ink, marginTop: 6, lineHeight: 21 },
})
