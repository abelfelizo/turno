...
export function TurnoMark({ size = 30, negative = false }: { size?: number; negative?: boolean }) {
  ...
  return (
    <Svg width={size} height={h} viewBox="0 0 110 76">
      <Defs>
        <Pattern id="tp" width={18} height={18} patternUnits="userSpaceOnUse" patternTransform="rotate(-35)">
        ...
        <ClipPath id="tc"><Path d="M6 2h98a4 4 0 0 1 4 4v24a8 8 0 0 0 0 16v24a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V46a8 8 0 0 0 0-16V6a4 4 0 0 1 4-4z" /></ClipPath>
      </Defs>
      <G clipPath="url(#tc)">
        <Rect width={110} height={76} fill={body} />
        <Rect width={28} height={76} fill="url(#tp)" />
      </G>
