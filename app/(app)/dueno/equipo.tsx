...
const s = StyleSheet.create({
  ...
  vacio: { fontFamily: FONTS.medium, fontSize: 13.5, lineHeight: 19, color: COLORS.textMid, paddingVertical: 18 },
  solicitudes: { marginTop: 18, backgroundColor: COLORS.carbon, padding: 14 },
  solT: { fontFamily: FONTS.extrabold, fontSize: 11, letterSpacing: 2, color: COLORS.onCarbonMid, marginBottom: 4 },
  sol: { flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 11, borderTopWidth: 1, borderTopColor: 'rgba(255,255,255,0.1)' },
  solNombre: { fontFamily: FONTS.extrabold, fontSize: 15.5, color: '#fff' },
  solMeta: { fontFamily: FONTS.medium, fontSize: 12.5, color: COLORS.onCarbonMid, marginTop: 2 },
  solNo: { width: 42, height: 42, borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.35)', alignItems: 'center', justifyContent: 'center' },
  solSi: { height: 42, paddingHorizontal: 14, backgroundColor: COLORS.red, alignItems: 'center', justifyContent: 'center', minWidth: 92 },
  solSiT: { fontFamily: FONTS.display, fontSize: 15, color: '#fff' },
  ...
  nombre: { flexShrink: 1, fontFamily: FONTS.extrabold, fontSize: 15.5, color: COLORS.ink },
  ...
  chip: { fontFamily: FONTS.extrabold, fontSize: 10, letterSpacing: 1, color: COLORS.ink, borderWidth: 1.5, borderColor: COLORS.ink, paddingHorizontal: 6, paddingVertical: 2 },
  chipAzul: { color: COLORS.blue, borderColor: COLORS.blue },
