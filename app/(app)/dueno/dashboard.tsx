...
const s = StyleSheet.create({
  ...
  codeCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.carbon, borderRadius: 6, padding: 18, marginBottom: 12 },
  ...
  share: { width: 44, height: 44, borderRadius: 4, backgroundColor: COLORS.red, alignItems: 'center', justifyContent: 'center' },
  ...
  colaBox: { backgroundColor: COLORS.carbon, borderRadius: 6, padding: 18, marginBottom: 22 },
  ...
  apagadoBox: { backgroundColor: COLORS.carbon, borderRadius: 6, padding: 18, marginBottom: 22,
  ...
  apagadoBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4,
    backgroundColor: '#fff', borderRadius: 4, paddingVertical: 12, marginTop: 2 },
  ...
  cerradoBox: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, backgroundColor: 'rgba(255,255,255,0.08)',
    borderRadius: 4, padding: 11, marginTop: 10 },
  ...
  sol: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: 6, padding: 12, marginBottom: 8 },
  ...
  rechazar: { width: 40, height: 40, borderRadius: 4, backgroundColor: COLORS.dangerLight, alignItems: 'center', justifyContent: 'center' },
  compartirCodigo: { width: 40, height: 40, borderRadius: 4, backgroundColor: COLORS.blueLight, alignItems: 'center', justifyContent: 'center' },
  colaVacia: { fontFamily: FONTS.medium, fontSize: 13, color: 'rgba(255,255,255,0.55)', marginTop: 16, lineHeight: 19 },
  silla: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: 6, padding: 14, marginBottom: 22 },
  sillaIcon: { width: 40, height: 40, borderRadius: 4, backgroundColor: COLORS.carbon, alignItems: 'center', justifyContent: 'center' },
  ...
  agregar: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: COLORS.surface, borderWidth: 1.5, borderColor: COLORS.border, borderStyle: 'dashed', borderRadius: 6, padding: 14, marginBottom: 10 },
  agregarIcon: { width: 40, height: 40, borderRadius: 4, backgroundColor: COLORS.blue, alignItems: 'center', justifyContent: 'center' },
  ...
  aprobar: { backgroundColor: COLORS.success, borderRadius: 4, paddingHorizontal: 14, paddingVertical: 10 },
  ...
  invInput: { backgroundColor: COLORS.surface, borderWidth: 1.5, borderColor: COLORS.border, borderRadius: 4,
    padding: 14, fontSize: 17, fontFamily: FONTS.bold, color: COLORS.ink, letterSpacing: 1.5, marginTop: 16 },
  invBtn: { backgroundColor: COLORS.red, borderRadius: 6, padding: 16, alignItems: 'center', marginTop: 18 },
