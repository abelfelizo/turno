...
const s = StyleSheet.create({
  ...
  sub: { fontFamily: FONTS.regular, fontSize: 13, lineHeight: 18, color: COLORS.textMid, marginTop: 4 },
  ...
  sillaN: { flex: 1, fontFamily: FONTS.semibold, fontSize: 15, color: COLORS.ink },
  ...
  sillaBarra: { height: 10, backgroundColor: GLASS.fillStrong, marginTop: 8, borderRadius: 5, overflow: 'hidden' },
  ...
  filaN: { flex: 1, fontFamily: FONTS.semibold, fontSize: 15, color: COLORS.ink },
