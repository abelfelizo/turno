...
const s = StyleSheet.create({
  ...
  estado: { flexDirection: 'row', alignItems: 'center', gap: 12, borderWidth: 1, borderColor: GLASS.border, padding: 15, borderRadius: GLASS.radioCard, backgroundColor: GLASS.fill },
