...
const s = StyleSheet.create({
  ...
  btnContorno: { width: 96, height: 44, borderWidth: 2, borderColor: COLORS.ink, alignItems: 'center', justifyContent: 'center' },
  btnContornoT: { fontFamily: FONTS.extrabold, fontSize: 13.5, color: COLORS.ink },
  avisar: { flexDirection: 'row', alignItems: 'center', gap: 12, marginTop: 20, borderRadius: 6, backgroundColor: COLORS.carbon, padding: 15 },
  avisarT: { flex: 1, fontFamily: FONTS.extrabold, fontSize: 14, color: '#fff' },
  fTitulo: { fontFamily: FONTS.display, fontSize: 26, lineHeight: 31, color: COLORS.ink, textTransform: 'uppercase', marginTop: 4 },
  ...
  input: { borderWidth: 2, borderColor: COLORS.ink, backgroundColor: COLORS.surface, padding: 13, marginTop: 12, minHeight: 90,
