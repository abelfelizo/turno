...
const s = StyleSheet.create({
  ...
  seg: { flex: 1, paddingVertical: 10, borderRadius: 4, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, alignItems: 'center' },
  ...
  wa: { width: 44, height: 44, borderRadius: 4, backgroundColor: COLORS.successLight, alignItems: 'center', justifyContent: 'center' },
  puntos: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: COLORS.red, borderRadius: 4, padding: 13, marginBottom: 4 },
  ...
  prefCelda: { flex: 1, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border,
    borderRadius: 4, paddingVertical: 10, paddingHorizontal: 11 },
  ...
  alerta: { flexDirection: 'row', alignItems: 'center', gap: 9, backgroundColor: COLORS.dangerLight,
    borderRadius: 4, paddingVertical: 10, paddingHorizontal: 12, marginBottom: 14 },
  ...
  input: { backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.border, borderRadius: 4, padding: 14, fontSize: 15, fontFamily: FONTS.medium, minHeight: 90, textAlignVertical: 'top', marginBottom: 16, color: COLORS.ink },
  ...
  btn: { backgroundColor: COLORS.blue, borderRadius: 6, padding: 16, alignItems: 'center' },
