...
const s = StyleSheet.create({
  ...
  btnContorno: { width: 96, height: 44, borderWidth: 1, borderColor: COLORS.border, alignItems: 'center', justifyContent: 'center', borderRadius: 8 },
  ...
  input: { borderWidth: 1, borderColor: COLORS.border, backgroundColor: COLORS.surface, padding: 13, marginTop: 12, minHeight: 90, fontFamily: FONTS.regular, fontSize: 14.5, color: COLORS.ink, textAlignVertical: 'top', borderRadius: 8, overflow: 'hidden' },
  guardar: { height: 52, backgroundColor: COLORS.ink, alignItems: 'center', justifyContent: 'center', marginTop: 12, borderRadius: 8 },
