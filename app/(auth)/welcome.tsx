...
const s = StyleSheet.create({
  ...
  btn: { width: '100%', padding: 17, backgroundColor: COLORS.red, borderRadius: 6, alignItems: 'center', marginBottom: 10 },
  btnT: { fontFamily: FONTS.bold, fontSize: 15, color: '#fff' },
  btn2: { width: '100%', padding: 16, backgroundColor: COLORS.carbonEl, borderRadius: 6, alignItems: 'center', borderWidth: 1, borderColor: COLORS.carbonBorder, marginBottom: 10 },
