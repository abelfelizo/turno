...
const s = StyleSheet.create({
  opcion: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.carbonEl, borderWidth: 1.5, borderColor: COLORS.carbonBorder, borderRadius: 8, padding: 18, marginBottom: 12 },
